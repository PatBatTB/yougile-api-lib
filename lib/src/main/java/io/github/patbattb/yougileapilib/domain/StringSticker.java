...
import io.github.patbattb.yougileapilib.http.deserialize.StringStickerDeserializer;
import lombok.*;
...
/**
 * Entity of string-sticker available on the {@link Board}
 */
@Getter
...
@EqualsAndHashCode
@ToString
@JsonDeserialize(using = StringStickerDeserializer.class)
public class StringSticker {
    ...
    String id;
    /**
     * If true, then the string-sticker has been deleted.
     */
    @Setter
    boolean deleted;
    /**
    ...
    @Setter
    Icon icon;
    List<StringStickerState> states;

    /**
     * The enumeration represents available icons for {@link StringSticker#icon}.
     */
    public enum Icon {
        EMPTY(""),
        STAR("star"),
         ...
         */
        public static StringSticker.Icon fromValue(String value) {
            for (StringSticker.Icon icon: StringSticker.Icon.values()) {
